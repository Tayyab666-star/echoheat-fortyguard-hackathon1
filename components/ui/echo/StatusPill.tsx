...
const STATUS_CONFIG: Record<StatusType, { dot: string; badge: string; label: string }> = {
  ...
  inactive:    { dot: "bg-muted-foreground", badge: "border-white/10 bg-surface-2 text-muted-foreground", label: "Inactive" },
  ...
  dismissed:   { dot: "bg-muted-foreground", badge: "border-white/10 bg-surface-2 text-muted-foreground", label: "Dismissed" },
